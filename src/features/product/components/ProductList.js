...
export default function ProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if(e.target.checked){
      ...
      const ind = newFilter[section.id].findIndex(el => el === option.value);
      newFilter[section.id].splice(ind, 1);
    }
    setFilter(newFilter);
  };
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <SortFilter setMobileFiltersOpen={setMobileFiltersOpen} handleSort={handleSort} />
          </div>
          ...
          <Pagination page={page} setPage={setPage} handlePage={handlePage} itemPerPage={ITEMS_PER_PAGE} totalItems={totalItems} />
        </main>
      </div >
    </div >
  );
...
function Pagination({page, setPage, handlePage, totalItems, itemPerPage}) {
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        ...
        <div
          onClick={(e) => handlePage(totalPage > page ? page+1 : page)}
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            Showing <span className="font-medium">{(page-1)*itemPerPage+1}</span> to{' '}
            <span className="font-medium">{page*itemPerPage}</span> of{' '}
        ...
        <div>
          ...
          >
            ...
            {Array.from({length: totalPage}).map((val, index) => <div key={index}
...
function SortFilter({ setMobileFiltersOpen, handleSort }) {
  return (
